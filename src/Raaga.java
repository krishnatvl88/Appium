...
public class Raaga extends base{
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		List<AndroidElement> xy = driver.findElementsByClassName("android.widget.RelativeLayout");
		System.out.println(xy);
		for(int i=0;i<xy.size();i++){
			if(xy.get(i).getText().contains("World Music")){
				System.out.println(xy.get(i));
			}
		}
		//driver.findElementById("com.raaga.android:id/text_view_lang").click();
		//driver.configuratorSetScrollAcknowledgmentTimeout(timeout);
		//driver.findElementByXPath("//android.widget.TextView[@text='Tamil']").click();
		//String str1="Hindi";
		...
		//String str2="com.raaga.android:id/music_home_raaga_live";
		//driver.findElementByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().resource-id(\""+str2+"\").instance(0))");
		/* 
